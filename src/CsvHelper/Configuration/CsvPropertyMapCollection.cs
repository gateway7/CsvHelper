...
namespace CsvHelper.Configuration
{
    ...
    public class CsvPropertyMapCollection : IList<CsvPropertyMap>
    {
        ...
        /// </exception>
        /// <exception cref="T:System.NotSupportedException">
        /// The property/field is set and the <see cref="T:System.Collections.Generic.IList`1" /> is read-only.
        /// </exception>
        ...
        {
            var existingMap = list.SingleOrDefault(
                                                   m =>
                                                       m.Data.Member == member ||
                                                       m.Data.Member.Name == member.Name &&
                                                       (
                                                           m.Data.Member.DeclaringType.GetTypeInfo().IsAssignableFrom(member.DeclaringType) ||
                                                           member.DeclaringType.GetTypeInfo().IsAssignableFrom(m.Data.Member.DeclaringType)
                                                       )
                                                  );
